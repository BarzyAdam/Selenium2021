...
//if I write 1 it gives me first one ,if i write 2 in the end of // it gives us second one
//how do i go to parent like for //span[.='iphone'] by adding one slash with two point like  //span[.='iPhone']/..
